...
```{r}
#| label: tbl-summary
#| tbl-cap: "Summary statistics of the cleaned Crime dataset"
#| message: false
#| echo: false

# Generate a summary and render it as a table
capture.output(summary(crime_data)) |>
  as.data.frame() |>
  knitr::kable(col.names = c("Summary Statistics"))
